...
export const auth = {
  ...
  signIn() {
    ...
    const params = new URLSearchParams({
      ...
      response_type: "code",
      scope:
        "streaming user-read-private user-read-email user-read-playback-state user-modify-playback-state user-read-currently-playing playlist-modify-public playlist-modify-private",
      state,
    });
